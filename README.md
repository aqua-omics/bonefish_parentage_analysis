...
Results: All dosages, except the sham (0 mg/kg), resulted in gonadal maturation. This led to two viable volitional spawns after induction with or without salmon Gonadotropin-Releasing Hormone analog (sGnRHa) implants. 
Conclusion: We used different methods to assess which females contributed to the two spawns, including analysis of monthly developmental patterns from fresh and preserved gonadal biopsies and genetic parentage analysis. In addition, an instance of the “pace-setting” response whereby sGnRHa implanted females stimulated un-implanted females to spawn may have occurred. 
